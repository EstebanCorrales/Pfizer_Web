pipeline{
    ...
    post{
        always{     
           ...
           publishHTML([allowMissing: false, alwaysLinkToLastBuild: false, keepAll: true, reportDir: 'cypress/report/html', reportFiles: 'index.html', reportName: 'HTML Report', reportTitles: ''])
